...
const ru = {
  hero: { 
    title: ["Каждое мероприятие", "Особенным", "Пусть Будет!"],
    subtitle: "Toilab — всё для мероприятий в одном приложении: ресторан, фотограф, ведущий, фейерверк, рассрочка и даже микрокредит.",
    stat1: "услуг и партнёров",
    stat2: "средняя оценка"
  },
  features: { 
    title: "Что умеет Toilab?",
    subtitle: "Полный набор инструментов для организации идеальныъх мероприятий",
    items: [
      { icon: <Search size={48} />, title: "1000+ услуг", desc: "Рестораны, фотографы, ведущие, декор и многое другое" },
      ...
      { icon: <Wallet size={48} />, title: "Рассрочка", desc: "60% клиентов выбирают удобную рассрочку" },
      { icon: <MessageCircle size={48} />, title: "Чат с подрядчиком", desc: "Договор и общение в одном месте" },
      { icon: <Smartphone size={48} />, title: "Мероприятия в телефоне", desc: "Все заказы и документы в одном приложении" }
    ]
  },
  benefits: {
  ...
  screenshots: { 
    ...
    subtitle: "Интуитивный и красивый интерфейс для удобства использования"
  },
  cta: { 
...
const kz = {
  ...
  cta: { 
    ...
    footer: "iOS және Android-те қол жетімді. Бірінші жүктеу — тегін!"
  }
};
