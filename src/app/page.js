...
const kz = {
  ...
  features: { 
    ...
    items: [
      ...
      { icon: <Wallet size={48} />, title: "Бөліп төлеу", desc: "Статистика бойынша клиенттердің 60%-ы ыңғайлы бөліп төлеуді таңдайды" },
      { icon: <Smartphone size={48} />, title: "Той телефонда", desc: "Барлық тапсырыстар бір қолданбада" }
    ]
  },
  benefits: {
