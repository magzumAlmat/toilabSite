        ...
        <div className="tl-guest" style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr', gap: 32 }}>
          ...
          <FadeIn>
            ...
            <h1 className="tl-display" style={{ fontSize: 'clamp(28px, 4.6vw, 46px)', fontWeight: 800, lineHeight: 1.08, color: 'var(--on-dark)', marginBottom: 14 }}>
              {t('Соберём ваш той', 'Тойыңызды')} <span className="tl-gold-text">{t('под бюджет', 'бюджетке сай қалыптастырамыз')}</span>
            </h1>
  ...
  return (
    <div>
      ...
      <PremiumHero
        ...
        title={t('Соберём ваш той', 'Тойыңызды')}
        accent={t('под бюджет — за минуту', 'бюджетке сай — бір минутта қалыптастырамыз')}
